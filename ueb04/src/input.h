...
struct InputData
{
    ...
    struct
    {
        ...
        float outerTessellation;
        bool useDistanceTessellation;
    ...
    struct
    {
        bool createDirShadows;
        bool createPointLightShadows;
        bool showDirShadows;
        bool showPointShadows;
        bool realtimeDirShadows;
        bool usePCF;
